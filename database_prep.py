...
html ='''<option value="AED">United Arab Emirates Dirham</option> 
...
# Extract the value and text from each <option> element
currencies = [{'code': option['value'], 'name': option.text} for option in options]
